...
u = User(username="teste1", email="teste1@gmail.com", password="123")
u.set_password("123")
u.is_active=True
u.save()
u.groups.add(leitor)
...
profile.create_matricula()
profile.save()
u = User(username="teste2", email="teste2@gmail.com", password="123")
u.set_password("123")
u.is_active=True
u.save()
u.groups.add(leitor)
...
profile.create_matricula()
profile.save()
u = User(username="teste3", email="teste3@gmail.com", password="123")
u.set_password("123")
u.is_active=True
u.save()
u.groups.add(leitor)
